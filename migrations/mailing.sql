...
(1, 'wyllismonteiro@gmail.com', '$argon2id$v=19$m=4,t=5,p=3$Fqbr$mEc', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdXRob3JpemVkIjp0cnVlLCJleHAiOjE1OTMwMDYxNDMsInVzZXIiOiJXeWxsaXMgTW9udGVpcm8ifQ.oRkp5E98N1DMYkZAFa9hluLTtLNDyIernt3fnPXpnuk');
...
INSERT INTO `campaign` (`id`, `message`, `broadcast_id`) VALUES
(1, "bonjour", 1);
...
ALTER TABLE `campaign`
  ADD CONSTRAINT `campaign_ibfk_1` FOREIGN KEY (`broadcast_id`) REFERENCES `broadcast` (`id`);
